  ...
  _createClass(DateInput, [{
    ...
    value: function () {
      function render() {
        ...
        var inputHeight = (0, _getInputHeight2['default'])({ lineHeight: lineHeight, inputPadding: inputPadding, displayTextPaddingVertical: displayTextPaddingVertical });

        return _react2['default'].createElement(
          'div',
          (0, _reactWithStyles.css)(styles.DateInput, withFang && styles.DateInput__withFang, disabled && styles.DateInput__disabled, withFang && openDirection === _constants.OPEN_DOWN && styles.DateInput__openDown, withFang && openDirection === _constants.OPEN_UP && styles.DateInput__openUp),
