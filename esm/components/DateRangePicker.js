...
import { START_DATE, END_DATE, HORIZONTAL_ORIENTATION, VERTICAL_ORIENTATION, ANCHOR_LEFT, ANCHOR_RIGHT, OPEN_DOWN, OPEN_UP, DAY_SIZE, ICON_BEFORE_POSITION, FANG_HEIGHT_PX, DEFAULT_VERTICAL_SPACING } from '../constants';
  ...
  _createClass(DateRangePicker, [{
    ...
    value: function () {
      function renderDayPicker() {
        ...
        var lineHeight = reactDates.font.input.lineHeight,
            _reactDates$spacing = reactDates.spacing,
            inputPadding = _reactDates$spacing.inputPadding,
            displayTextPaddingVertical = _reactDates$spacing.displayTextPaddingVertical;

        var inputHeight = getInputHeight({ lineHeight: lineHeight, inputPadding: inputPadding, displayTextPaddingVertical: displayTextPaddingVertical });

        return React.createElement(
          'div',
          _extends({ // eslint-disable-line jsx-a11y/no-static-element-interactions
            ref: this.setDayPickerContainerRef
          }, css(styles.DateRangePicker_picker, anchorDirection === ANCHOR_LEFT && styles.DateRangePicker_picker__directionLeft, anchorDirection === ANCHOR_RIGHT && styles.DateRangePicker_picker__directionRight, orientation === HORIZONTAL_ORIENTATION && styles.DateRangePicker_picker__horizontal, orientation === VERTICAL_ORIENTATION && styles.DateRangePicker_picker__vertical, openDirection === OPEN_DOWN && {
